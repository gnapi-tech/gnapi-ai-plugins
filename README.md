...
## Using on other agents (Codex, Cursor, opencode, Antigravity, Gemini)
...
```shell
node portable/build-shims.mjs   # regenerate every shim from SKILL.md + portable/STANDARDS.md
```

| Harness | Generated artifact |
|---------|--------------------|
...
what does/doesn't carry over: see [`portable/README.md`](portable/README.md).
